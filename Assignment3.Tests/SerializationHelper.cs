...
namespace Assignment3.Tests
{
    public static class SerializationHelper
    {
        ...
        {
            DataContractSerializer serializer = new DataContractSerializer(typeof(ILinkedListADT));
        ...
        {
            DataContractSerializer serializer = new DataContractSerializer(typeof(SLL)); // Specify the type as SLL
